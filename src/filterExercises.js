...
export const getStudentsByInstructorId = () => {
...
export const getPolyglotStudents = (languageCount) => {
    const studentWithMultipleLanguage = students.filter(
        (students) => students.languages.length >= languageCount
    )
    return studentWithMultipleLanguage;
}
